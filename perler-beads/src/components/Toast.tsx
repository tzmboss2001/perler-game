...
const toastConfig: Record<ToastType, { icon: React.ReactNode; color: string; bg: string; border: string }> = {
  success: {
    ...
    bg: `linear-gradient(145deg, rgba(255,255,255,0.98), ${colors.bead.green}22)`,
    border: `${colors.bead.green}66`,
  },
  error: {
    icon: <XCircle size={20} weight="fill" />,
    color: colors.bead.pink,
    bg: `linear-gradient(145deg, rgba(255,255,255,0.98), ${colors.bead.pink}22)`,
    border: `${colors.bead.pink}66`,
  },
  info: {
    icon: <Info size={20} weight="fill" />,
    color: colors.bead.cyan,
    bg: `linear-gradient(145deg, rgba(255,255,255,0.98), ${colors.bead.cyan}22)`,
    border: `${colors.bead.cyan}66`,
  },
  warning: {
    icon: <Warning size={20} weight="fill" />,
    color: colors.bead.orange,
    bg: `linear-gradient(145deg, rgba(255,255,255,0.98), ${colors.bead.orange}24)`,
    border: `${colors.bead.orange}70`,
  },
};
